...
<div class="metadata">
   ...
   <ul>
      <li>
         <a href="https://github.com/tboenig/gt_structure_text_test/releases/tag/v1.0.0">The BagIt 'ocrd.zip' files for the current version, please download them from the latest release.: Release 1_v1.0.0</a>
      </li>
      <li>
