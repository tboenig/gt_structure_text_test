...
<div class="metadata">
   ...
   <ul>
      <li>
         <a href="https://github.com/tboenig/gt_structure_text_test/releases/tag/v1.0.2">The BagIt 'ocrd.zip' files for the current version, please download them from the latest release.: Release 3_v1.0.2</a>
      </li>
      <li>
