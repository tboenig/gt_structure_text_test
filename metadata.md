...
<div class="metadata">
   ...
   <ul>
      <li>
         <a href="https://github.com/tboenig/gt_structure_text_test/releases/tag/v1.0.5">The BagIt 'ocrd.zip' files for the current version, please download them from the latest release.: Release 6_v1.0.5</a>
      </li>
      <li>
